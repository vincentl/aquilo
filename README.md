...
The Whipped Cream example grouped four ingredients into a single node. A group node consists of two or more nodes and is solely used for display purposes.
- **kind**: group
- **uuid**: _4A7D3B86-D3D8-4EB0-8D7E-EDB7DA16DC33_
- **nodes**: [_7B01EB97-A974-48E1-BA13-E482D81ED5ED_, _C33FB5E1-6B19-49E6-81B7-74260E989E5E_]
- css: _null_
- description: _null_
- yaml: _{version: 1.3.4}_
...
## Registry
- [Operations](schemas/operations.yaml) registry is a list of valid operations.  Each operation is described in a separate schema file in a [subdirectory](schemas/operations)
- [Vessels](schemas/vessels.yaml) registry is a list of valid vessels
- [Tools](schemas/tools.yaml) registry is a list of valid tools
- [Termination Conditions](schemas/termination-conditions.yaml) registry is a list of valid termination conditions
